...
- Если пользователь сообщает что выполнил упражнения или тренировку — сразу вызывай log_workout_entry для каждого упражнения отдельно (exercise, sets, reps, weight_kg)
