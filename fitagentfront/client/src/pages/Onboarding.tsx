...
const ACTIVITIES = [
  {
    ...
    desc: "Офис, мало движения",
  },
  {
    value: "moderate",
    label: "Умеренная активность",
    desc: "1–3 тренировки в неделю",
  },
...
export default function Onboarding() {
  ...
  const handleSubmit = () => {
    updateProfile.mutate({
      ...
      activity:
        (activity as "sedentary" | "moderate" | "active" | "athlete") ||
        undefined,
      goal:
        (goal as "lose" | "gain" | "maintain" | "recomposition") || undefined,
            ...
            return (
              <div key={i} className="flex items-center gap-2">
                ...
                >
                  <Icon
                    size={16}
                    className={active || done ? "text-white" : "text-white/30"}
                  />
                </div>
                {i < STEPS.length - 1 && (
                  <div
                    className={`w-8 h-px transition-all duration-300 ${done ? "bg-purple-500/60" : "bg-white/10"}`}
                  />
                )}
              </div>
            );
            ...
            <div className="space-y-6 animate-slide-in-down">
              <div>
                ...
                <p className="text-white/50 text-sm">
                  Это имя будет использоваться в общении с AI-тренером
                </p>
              </div>
              <div>
          ...
          {step === 1 && (
            <div className="space-y-6 animate-slide-in-down">
              <div>
                ...
                <p className="text-white/50 text-sm">
                  Нужны для расчёта КБЖУ и программы тренировок
                </p>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-6 animate-slide-in-down">
              <div>
                ...
                <p className="text-white/50 text-sm">
                  Выбери то, что лучше всего тебя описывает
                </p>
              </div>
          ...
          {step === 3 && (
            <div className="space-y-6 animate-slide-in-down">
              <div>
                ...
                <p className="text-white/50 text-sm">
                  Это поможет AI-тренеру составить безопасную программу
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-white/20 mt-1 text-right">
                  {injuries.length}/2000
                </p>
              </div>

              <div className="p-4 rounded-xl bg-purple-500/10 border border-purple-500/20">
                <p className="text-xs text-purple-300">
                  Данные хранятся только для персонализации тренировок и не
